...
[---]        """+wi+"""Dark Z"""+gr+"""        [---]
==================================
[---]  """+wi+"""Facebook BruteForcer V2.0"""+gr+""" [---]
==================================
[---]         """+yl+"""CONFIG"""+gr+"""         [---]
==================================
[>] Target id      :> """+wi+target+gr+"""
{}""".format("[>] Wordlist Path   :> "+yl+str(wordlist) if not single_passwd else "[>] Password    :> "+yl+str(single_passwd))+gr+"""
...
❥▦▦▦▦R▦▦▦▦▦▦▦▦▦▦❥▦❥▦▦▦▦▦▦▦▦▦R▦▦▦❥❥•❥•❥•❥•❥•❥•❥•❥•
❥▦▦▦▦K▦▦▦▦▦▦▦▦▦▦❥▦▦▦▦▦▦▦▦▦▦▦K▦▦❥❥•❥•❥•❥•❥•❥•❥•❥•
     You need a Strong wordlist to hack someone's account

Example: python DarkZ.py -t (victims Numberic id) -w (wordlist path)
""")
